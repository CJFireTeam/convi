...
import {
  api_deleteCourse,
  api_getEstablishmentCoursesByUser,
  api_getEstablishmentCoursesSinPag,
  api_getOneUser,
  api_postCourses,
  api_putEstablishmentCourses,
  api_role,
  api_updateCourses,
  api_updateUser,
...
export default function EditarUsuarioAut() {
  ...
  useEffect(() => {
    if (dataUser && dataUser.region && regionList.length > 0) {
      handleChangeRegion(dataUser.region); // 👈 Solo llama si regionList está cargada
    }
  }, [dataUser, regionList]);
  ...
  useEffect(() => {
    if (comunaList.length > 0 && dataUser?.comuna) {
      setValue("comuna", dataUser.comuna);
    }
  }, [comunaList, dataUser]);
              ...
              <div className="md:col-start-2 md:col-end-13">
                <div className="grid md:grid-cols-2 mb-4">
                  ...
                  <div className="md:mr-4">
                    ...
                    <Input
                      ...
                      defaultValue={dataUser?.secondname}
                    />
                  </div>
                  ...
                  <div className="md:mr-4">
                    ...
                    <Input
                      ...
                      defaultValue={dataUser?.first_lastname}
                    />
                  ...
                  <div className="md:mr-4">
                    ...
                    <Input
                      ...
                      type="text"
                      className="input input-primary w-full"
                      defaultValue={dataUser?.second_lastname}
                    />
                  ...
                  <div className="md:mr-4 my-auto">
                    <label className="inline-flex items-center">
                      ...
                      <input
                        type="checkbox"
                        {...register("confirmed")}
                        className="toggle toggle-primary bg-white"
                        defaultChecked={dataUser?.confirmed}
                      />
                    </label>
                  </div>
                  ...
                  <div className="md:mr-4 my-auto">
                    <label className="inline-flex items-center">
                      ...
                      <input
                        ...
                        {...register("blocked")}
                        className="toggle toggle-primary bg-white"
                        defaultChecked={dataUser?.blocked}
                      />
                    </label>
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-4">
                  {!loadingButton && (
                    <button
                      type="submit"
                      className="btn btn-outline btn-primary w-full col-span-1"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
...
export function InsertCourse(props: props) {
  ...
  const getCoursesByUser = async () => {
    try {
      setLoading(true);
      const data = await api_getEstablishmentCoursesByUser(
        props.establishmentId,
  ...
  const CourseSchema = z.object({
    establishment_courses: z.number({
      required_error: "Campo requerido",
  ...
  const onSubmit = async (data: IFormCourse) => {
    try {
      if (props.tipo == "alumno" && courseByUser.length === 0) {
        ...
        const response = await api_putEstablishmentCourses(
          parseInt(props.userId),
          {
      ...
      if (props.tipo == "apoderado") {
        ...
        const updatedCourses = [
          ...currentCourseIds,
          data.establishment_courses,
        ]; // Añade el nuevo curso
  ...
  const defaultValue =
    courseByUser.length > 0 && courseByUser.length > 0
      ? courseByUser[0].id
      : undefined;
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="grid md:grid-cols-3 items-center p-4">
            ...
            <div className="md:mr-2">
              <label htmlFor="letra" className="font-semibold">
                Curso:{" "}
              </label>
              <Controller
                control={control}
                ...
                defaultValue={
                  courseByUser.length > 0 ? courseByUser[0].id : undefined
                }
              ...
              />
              {errors.establishment_courses?.message && (
                <p className="text-red-600 text-sm mt-1">
                  {errors.establishment_courses.message}
                </p>
              )}
            ...
            <div className="mt-2 md:mt-5">
              {!loadingButton && (
                <button
                  type="submit"
                  className="btn btn-primary btn-outline w-full row-start-1"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
          ...
          <div className="grid md:grid-cols-3 items-center p-4">
            ...
            <div className="mt-2 md:mt-5">
              {!loadingButton && (
                <button
                  type="submit"
                  className="btn btn-outline btn-primary w-full row-start-1"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
              ...
              <div className="grid md:grid-cols-4 items-center text-center mt-4">
                <div className="md:col-span-4">
                  <p className="text-xl font-bold">
                    Cursos relacionados a este usuario
                  </p>
                </div>
                    ...
                    <div key={index} className="m-2">
                      <Card className="mt-2">
                        ...
                        <CardFooter className="flex justify-center">
                          <p
                            className="font-semibold text-lg text-error cursor-pointer"
                            onClick={() => {
                              const modal = document.getElementById(
                                `my_modal_${c.id}`
                              ) as HTMLDialogElement; // Usando ID único
                              modal?.showModal();
                            }}
                          >
                            Eliminar
                    ...
                    <dialog id={`my_modal_${c.id}`} className="modal">
                      <div className="modal-box bg-white flex flex-col items-center">
                        <h3 className="font-bold text-lg text-center">
                          ¿Estas seguro que quieres borrar el curso?
                        </h3>
