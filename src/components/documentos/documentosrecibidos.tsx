...
import { api_getDocumentsByUserDestinity2, api_putDocument } from "@/services/axios.services";
...
export default function DocumentosRecibidos(props: props) {
    ...
    }, [props.establishmentId, props.userId, metaData.page]);
