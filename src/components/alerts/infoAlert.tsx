  ...
  export default function InfoAlert(props: Props) {
    return (
      <div className="flex flex-row justify-center mt-3">
        <div className="rounded-3xl bg-[#E5F9F6] border-2 border-[#2196F3] flex items-center flex-row md:pt-2 md:pr-6 md:pb-2 md:pl-4">
          <div className="m-4">
          <svg
          ...
          <div className="flex flex-col justify-start">
            ...
            {props.action && (
              <a onClick={props.action} className="mx-4 text-sm text-left md:text-base my-4 md:my-0 md:mt-3">
                Ver más
              </a>
            )}
          </div>
