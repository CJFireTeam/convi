  ...
  try {
    ...
    const me = async () => {
      try {
        ...
        setnameUser(capitalizeFirstLetter(token.firstname) + ' ' + capitalizeFirstLetter(token.first_lastname))
        const data = await axios.get(process.env.NEXT_PUBLIC_BACKEND_URL + 'api/auth/me')
    ...
    <>
      ...
      */}
      <div>
            ...
            <nav className="flex flex-1 flex-col">
              <ul role="list" className="flex flex-1 flex-col gap-y-7">
                ...
                <li className="-mx-6 mt-auto">
                  ...
                  >
                    <UserIcon className="h-8 w-8 rounded-full bg-gray-800"></UserIcon>
                    <span className="sr-only">Your profile</span>
                    <span aria-hidden="true">{nameUser}</span>
                  </a>
                </li>
              </ul>
            </nav>
        ...
        <main className="py-10 lg:pl-72 bg-gray-300 min-h-screen">
