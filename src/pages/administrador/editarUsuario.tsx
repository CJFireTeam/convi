            ...
            <div className="grid md:grid-cols-2">
              ...
              <div className="md:mr-4 my-auto mb-2">
                <label className="inline-flex items-center">
                  ...
                  <input
                    type="checkbox"
                    {...register("canUploadDoc")}
                    className="toggle toggle-primary bg-white"
                    defaultChecked={dataUser?.canUploadDoc}
                  />
                </label>
              </div>
...
export function InsertCourse(props: props) {
  ...
  const getCoursesEstablishment = async () => {
    try {
      ...
      const filteredCourses = establishmentCourses.filter(
        (course: any) =>
              ...
              render={({ field: { onChange, value, name, ref } }) => (
                <Select
                  ...
                  getOptionLabel={(option) =>
                    option.attributes.Grade +
                    " " +
                    option.attributes.Letter +
                    " " +
                    option.attributes.establishment.data.attributes.name
                  }
